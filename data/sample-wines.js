// Sample wine data used to seed a freshly-created/empty 'wines' collection.
// This is the same dataset the old raw-driver routes/wines.js's populateDB()
// used to insert the first time the collection didn't exist; see app.js.
module.exports = [
    {
